...
/***/ function(module, exports, __webpack_require__) {
	...
	var addEventHandler = function addEventHandler(element, type, handler) {
	...
	addEventHandler(window, "load", function () {
	    ...
	    addEventHandler(sortBtn, "click", function () {
	        if (!document.getElementById("dist")) {
	            (function () {
	                var list = [];
	                Array.from(document.querySelectorAll("#src li")).forEach(function (element, index) {
	                    /^(.*)\u7a7a\u6c14\u8d28\u91cf\uff1a<span>(\d+)<\/span>$/g.exec(element.innerHTML);
	                    list[index] = [RegExp.$1, RegExp.$2];
	                });
	                var dist = document.createElement("ul");
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(290)(module), __webpack_require__(291)))
